...
sudo pip install setuptools Flask Cython Keras mxnet-cu80 sklearn pandas matplotlib h5py pillow tinydb requests simplejson opencv-python jsonpickle pytesseract nltk chatterbot urllib urllib2 easydict padatious seaborn mpld3
