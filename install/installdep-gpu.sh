...
sudo pip install setuptools Flask Cython Keras tensorflow mxnet-cu80 sklearn pandas matplotlib h5py pillow requests simplejson opencv-python jsonpickle pytesseract nltk chatterbot urllib urllib2 easydict padatious seaborn mpld3 psutil nvidia-ml-py flask_cors passlib
